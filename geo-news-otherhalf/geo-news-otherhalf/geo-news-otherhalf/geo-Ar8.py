...
#pagination
pages = driver.find_element(By.XPATH, '//ul/li/div[@class="heading"]/a[@data-article_name="Mirpurkhas man killed in stampede amid sale of subsidised flour"]')
heads = []
...
df_books.to_csv('geo_8.cvs', index=False, encoding='utf-8')

dat = pd.read_csv('geo_8.cvs')
