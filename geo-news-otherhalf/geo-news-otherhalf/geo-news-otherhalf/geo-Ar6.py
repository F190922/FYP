...
#pagination
pages = driver.find_element(By.XPATH, '//ul/li/div[@class="heading"]/a[@data-article_name="Several leaders from Balochistan join PPP after meeting Asif Ali Zardari"]')
heads = []
...
df_books.to_csv('geo_6.cvs', index=False, encoding='utf-8')

dat = pd.read_csv('geo_6.cvs')
