...
#pagination
pages = driver.find_element(By.XPATH, '//ul/li/div[@class="heading"]/a[@data-article_name="China reopens borders in final farewell to zero-COVID"]')
heads = []
...
df_books.to_csv('geo_9.cvs', index=False, encoding='utf-8')

dat = pd.read_csv('geo_9.cvs')
