...
#pagination
pages = driver.find_element(By.XPATH, '//ul/li/div[@class="heading"]/a[@data-article_name="Exchange firms willing to open LCs for imports at open market rates"]')
heads = []
...
df_books.to_csv('geo_7.cvs', index=False, encoding='utf-8')

dat = pd.read_csv('geo_7.cvs')
