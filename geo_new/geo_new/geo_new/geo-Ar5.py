...
#pagination
pages = driver.find_element(By.XPATH, '//ul/li/div[@class="heading"]/a[@data-article_name="ECP completes preparation for Karachi-Hyderabad LG polls: sources"]')
heads = []
...
df_books.to_csv('geo_5.cvs', index=False, encoding='utf-8')

dat = pd.read_csv('geo_5.cvs')
