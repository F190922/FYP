...
#pagination
pages = driver.find_element(By.XPATH, "//ul/li/div[@class=\"heading\"]/a[@data-article_name=\"PM Shehbaz, IMF chief hold 'constructive' call on Geneva moot\"]")
heads = []
...
df_books.to_csv('geo_4.cvs', index=False, encoding='utf-8')

dat = pd.read_csv('geo_4.cvs')
