...
#pagination
pages = driver.find_element(By.XPATH, '//ul/li/div[@class="heading"]/a[@data-article_name="IMF conditions to push inflation 40% high in Pakistan: Hammad Azhar"]')
heads = []
...
df_books.to_csv('geo_2.cvs', index=False, encoding='utf-8')

dat = pd.read_csv('geo_2.cvs')
