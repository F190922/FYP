...
#pagination
pages = driver.find_element(By.XPATH, "//ul/li/div[@class=\"heading\"]/a[@data-article_name=\"Aleem, Awn Chaudhry dismiss reports of forming 'new party'\"]")
heads = []
...
df_books.to_csv('geo_3.cvs', index=False, encoding='utf-8')

dat = pd.read_csv('geo_3.cvs')
